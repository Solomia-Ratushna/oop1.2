...
//////////////////////////////////////////////////////////////////////////////
// Account.cpp
// файл реал≥зац≥њ Ц реал≥зац≥€ метод≥в класу
#include "Account.h"
...
void Account::Read()
{
	...
	do
	{
		...
		cout << "¬вед≥ть дан≥:" << endl;
		cout << " Ќомер рахунку= ? "; cin >> no;
		cout << " ≤м€= ? ";   cin >> name;
		cout << " —ума= ? "; cin >> summa;
		cout << " ¬≥дсоток нарахуванн€ = ? "; cin >> percent;
...
void Account::Display()
{
	cout << "____________________" << endl;
	cout << "¬аш≥ дан≥:" << endl;
	cout << " Ќомер рахунку= " << no << endl;
	cout << " ≤м€ = " << name << endl;
	cout << " —ума= " << summa << endl;
	cout << " ¬≥дсоток нарахуванн€ = " << percent << endl;
	cout << "____________________" << endl;
}
